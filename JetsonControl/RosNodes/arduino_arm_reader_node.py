...
class ArduinoArmReaderNode(Node):
    def __init__(self):
        super().__init__('arduino_arm_reader_node')
        self.ser = serial.Serial('/dev/ttyUSB0', 115200, timeout=1)  # Adjust the port and baudrate as needed
